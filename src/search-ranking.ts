...
import type { ServerEntry, ToolMetadata, ToolPrefix } from './types.js'
import { getServerPrefix, getToolNameCandidates, isServerDisabled, matchesToolPattern, resolveToolPrefix } from './types.js'
...
export function rankSuggestions(state: McpRuntimeState, name: string, limit: number): string[] {
